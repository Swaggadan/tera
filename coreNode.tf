...
resource "vultr_startup_script" "energi" {
    name = "energi"
    script = "#!/bin/sh\nsudo apt update && sudo apt upgrade -y && wget https://gist.githubusercontent.com/Swaggadan/91f6b116ba739fa8581723fc25e3b455/raw/a5cce9d5660fa1a6cb1283b0406ccf880a1f2e07/energi3.sh && chmod 777 energi3.sh && ./energi3.sh && wget ${var.key_store} -P /root/ && mv /root/UTC* /home/nrgstaker/.energicore3/keystore/ && chmod 600 /home/nrgstaker/.energicore3/keystore/UTC* && chown -R nrgstaker:nrgstaker /home/nrgstaker/.energicore3/keystore/"
